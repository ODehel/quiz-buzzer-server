 ...
 */
export function startHeartbeat(ws: WebSocket, connectionEntry: ConnectionEntry, {
 ...
 */
export function stopHeartbeat(ws: WebSocket, { clearIntervalFn = globalThis.clearInterval }: { clearIntervalFn?: typeof clearInterval } = {}): void {
